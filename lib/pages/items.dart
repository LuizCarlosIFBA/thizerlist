...
class ItemsPage extends StatefulWidget {
  ...
  static final String tag = 'items-page';
...
class _ItemsPageState extends State<ItemsPage> {
  ...
  // Veja https://pub.dartlang.org/packages/flutter_masked_text
      ...
      builder: (BuildContext ctx) {
        ...
        final inputValor = TextFormField(
          ...
          validator: (value) {
            ...
            double realVal = double.tryParse(value) ?? null;

            // Pode ser de graça, mas nao pode ser negativo
            if (realVal < 0.0) {
              return 'Obrigatório';
            }
          },
